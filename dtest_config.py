...
class DTestConfig:
    ...
    def setup(self, request):
        ...
        self.cassandra_dir = request.config.getoption("--cassandra-dir") or request.config.inicfg.get("cassandra_dir")
        if self.cassandra_dir is not None:
            self.cassandra_dir = os.path.expanduser(self.cassandra_dir)
